...
struct HashTable{
    ...
    //add an if condition to complete the code here
        if (empty) {
            ...
            cout << "User Added to the Hashtable\n";
        }
        else {
            cout << "Slot is filled, try a different key or deleting a previous username\n";
        }
    ...
    //add an if condition to complete the code here
        if (!empty) {
            cout << password[hash] << " is the password of "  << user_name << endl;
        }
        else {
